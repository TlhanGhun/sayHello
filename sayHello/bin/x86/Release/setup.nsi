...
!define ENGINE_NAME "sayHello"


; The name of the installer
Name "Snarl Style Say Hello"

; The file to write
OutFile "Setup-SayHello.exe"


; The default installation directory
InstallDir "$PROGRAMFILES\Tlhan Ghun\Styles\Say Hello"

; Registry key to check for directory (so if you install again, it will 
; overwrite the old one automatically)
InstallDirRegKey HKLM "Software\TlhanGhun\Styles\Say Hello" "Install_Dir"
...
!define MUI_WELCOMEPAGE_TITLE "Snarl style Say Hello"
!define MUI_WELCOMEPAGE_TEXT "Speaks the notifications"
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Tlhan Ghun\Styles\Say Hello"
!define MUI_ICON "sayHello.ico"
...
; Pages
  ...
  !define MUI_STARTMENUPAGE_REGISTRY_KEY "Software\TlhanGhun\Styles\Say Hello" 
...
Section "Snarl style Say Hello files"
  SectionIn RO
  ...
  call checkforsnarl  
  ExecWait '$R0\snarlm.exe -us sayHello.styleengine'
  Sleep 500
...
;  File "Newtonsoft.Json.dll"
  ...
  WriteRegStr HKLM SOFTWARE\TlhanGhun\SnarlStyleSayHello "Install_Dir" "$INSTDIR"
  
  ; Write the uninstall keys for Windows
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\SnarlStyleSayHello" "DisplayName" "Snarl Style Say Hello"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\SnarlStyleSayHello" "UninstallString" '"$INSTDIR\uninstall.exe"'
  WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\SnarlStyleSayHello" "NoModify" 1
  WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\SnarlStyleSayHello" "NoRepair" 1
...
; Register the assembly
  ...
  StrCpy $0 '"$1\RegAsm.exe" "$2\sayHello.dll" /codebase'  
  DetailPrint $0
  nsExec::ExecToLog $0
  pop $0
...
GetFullPathName /SHORT $1 $R0
GetFullPathName /SHORT $2 $INSTDIR
StrCpy $0 '"$1\RegAsm.exe" "$2\sayHello.dll" /unregister'
DetailPrint $0
nsExec::ExecToLog $0
pop $0
  ...
  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\SnarlStyleSayHello"
  DeleteRegKey HKLM "Software\TlhanGhun\Styles\Say Hello"
  ...
  DeleteRegKey HKCU "Software\TlhanGhun\Styles\Say Hello"
...
Push 10 #maximum amount of directories to remove
  ...
  Delete "$APPDATA\full phat\snarl\styles\sayHello.styleengine"
